...
function FaqItem({ faq, index, isOpen, onToggle }) {
  ...
  return (
    <div
      ref={itemRef}
      className={`faq-item bg-white rounded-2xl border transition-all duration-500 overflow-hidden ${
        isOpen ? "border-gray-200 shadow-[0_8px_30px_rgba(0,0,0,0.06)]" : "border-gray-100 hover:border-gray-200 hover:shadow-[0_4px_20px_rgba(0,0,0,0.03)]"
      }`}
    >
      <button
        onClick={onToggle}
      ...
      >
        ...
        <div className="flex-1 min-w-0">
          ...
          <h3 className="text-sm sm:text-base font-bold text-gray-900 tracking-tight leading-snug">{faq.q}</h3>
        </div>
        <span className={`faq-chevron shrink-0 transition-colors duration-300 text-lg ${isOpen ? "text-gray-900" : "text-gray-300 group-hover:text-gray-500"}`}>∨</span>
      </button>
      <div ref={contentRef} className="overflow-hidden" style={{ height: 0, opacity: 0 }}>
        <div className="px-4 sm:px-5 pb-4 sm:pb-5 pl-[60px] sm:pl-[68px]">
          <div className="p-3 sm:p-4 rounded-xl bg-gray-50/80 border border-gray-100/50">
  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 max-w-[1700px] mx-auto px-4 sm:px-6 md:px-10 lg:px-20 xl:px-[120px] py-10 sm:py-14 md:py-20 lg:py-28">
        ...
        <div className="footer-cta bg-gradient-to-br from-gray-50 to-gray-100/50 rounded-2xl border border-gray-100 p-6 sm:p-8 text-center max-w-3xl mx-auto">
          ...
          <h3 className="text-lg sm:text-xl font-bold text-gray-900 tracking-tight mb-2">Still Have Questions?</h3>
